...
void print_winner(void)
{
    ...
    {
        if (topCandidateVotes < candidates[current_candidate].votes)
        {
            topCandidateVotes = candidates[current_candidate].votes;
        }
    ...
    {
        if (candidates[current_candidate].votes == topCandidateVotes)
        {
